class Registration < ApplicationRecord
  ...
  HAVE_PENDING_RESULTS = ["Olivér Perge", "Bence Barát", "Niki Placskó", "István Kocza", "Dániel Varga", "Hunor Mogyorósi", "Salamon Tűzkő", "Brúnó Bereczki", "Tomáš Zatroch", "Diego Bojunga Meneghetti", "Matheus Barbosa de Miranda", "Marjorie Marbly Miranda Nunes", "Fabio Bini Graciose", "Iuri Grangeiro Carvalho", "Henrik Buus Aagaard", "Christian Smedegaard", "Clément Cherblanc", "Oscar Roth Andersen", "Zoé de Moffarts", "Daniel Vædele Egdal", "Martin Vædele Egdal", "Rasmus Stub Detlefsen", "Nathaniel Berg", "Simon Nilsson", "Theo Lyholm", "Karina Grandjean Beck", "Fredrik Trondhjem", "Magnus Patrick Kanstrup", "Karl Taagaard Hansen", "Jeremy Fleischman", "Antoine Cantin", "Jayden McNeill", "Eduard Esteban García Domínguez", "Feliks Zemdegs", "James Macdiarmid", "Claude Cantin", "Luis Alejandro Carvajal Cruz", "Jeremy Fleischman", "Ricardo Piotti", "Antoine Cantin", "Jayden McNeill", "Diego Bojunga Meneghetti", "Eduard Esteban García Domínguez", "Ernesto Cabrera", "Bautista Bonazzola", "Feliks Zemdegs", "James Macdiarmid", "Claude Cantin", "Luis Alejandro Carvajal Cruz", "Santiago Baso", "Manuel Oribe", "Mellany Dorneles Araújo", "Cristian Ezequiel Vega", "Alexander Olleta del Molino", "Clément Cherblanc", "Eki González García", "Daniel Gracia Ortiz", "Celia López Martín", "Julio Perugorria Lorente", "Zaloa Aguirre", "Adrián Martínez Macías", "Wilfrid Py", "Javier Álvarez Suárez", "Firstian Fushada", "Weston Mizumoto", "Kevin Hays", "Kevin Guillaumond", "Anthony Brooks", "David Adams", "David Armstrong", "Evan Liu"].freeze
end
