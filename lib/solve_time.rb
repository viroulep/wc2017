...
# Taken from https://github.com/thewca/worldcubeassociation.org/tree/master/WcaOnRails/lib
# It's the reference implementation of the WCA results described here: https://www.worldcubeassociation.org/results/misc/export.html
class SolveTime
